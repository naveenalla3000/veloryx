...
export default function Navbar() {
  return (
    <nav className="fixed top-0 w-full z-50 bg-background/60 backdrop-blur-xl border-b border-white/10 shadow-[0_0_20px_rgba(16,185,129,0.1)]">
      <div className="flex justify-between items-center px-margin-mobile md:px-margin-desktop py-4 w-full max-w-[1440px] mx-auto">
        <Image src="/logo.png" alt="Veloryx Technologies" width={160} height={54} className="object-contain mix-blend-screen" priority />
